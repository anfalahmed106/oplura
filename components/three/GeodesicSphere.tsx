...
> = {
  ...
  low: { sphereSegments: 10, cylinderSegments: 3, lightTier: 1 },
  medium: { sphereSegments: 16, cylinderSegments: 4, lightTier: 2 },
  high: { sphereSegments: 24, cylinderSegments: 4, lightTier: 3 },
};
